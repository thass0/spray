...
(define (test-colorize)
  ...
  (assert (equal? (colorize  "int Äpfel = (6 + 4) * 9;")
  ...
  (assert (equal? (colorize "int main(void) {\n    /* blah */\n    printf(\"blah\");\n}\n")
		  '((tt-type . "int") (tt-whitespace . " ") (tt-identifier . "main")
		    (tt-special-symbol . "(") (tt-type . "void") (tt-special-symbol . ")")
		    (tt-whitespace . " ") (tt-special-symbol . "{") (tt-newline . "\n")
  ...
  (assert (equal? (colorize "int blah = 5;\n/* I don't end,\nBut this is still me")
  ...
  (assert (equal? (colorize "int main(void) */ {int a = 0;")
  ...
  (assert (equal? (colorize "int\na\n=\n2;\n */ /* another comment */")
		  '((tt-comment-text . "int") (tt-newline . "\n") (tt-comment-text . "a")
		    ...
		    (tt-uncomment . "*/"))))
  (assert (equal? (colorize "int a = 7;  // This C++ style comment can contain this */ or that /*.")
		  '((tt-type . "int") (tt-whitespace . " ") (tt-identifier . "a")
		    (tt-whitespace . " ") (tt-operator . "=") (tt-whitespace . " ")
